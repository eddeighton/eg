...
#ifndef W__WORKSPACE_EG_SRC_SCHEMA_INSTALLATION_SCHEMA_PSKEL_HXX
#define W__WORKSPACE_EG_SRC_SCHEMA_INSTALLATION_SCHEMA_PSKEL_HXX
...
namespace installationxml
{
  class Installation_pskel: public ::xsde::cxx::parser::validating::complex_content
  {
    public:
    ...
    void
    Python_parser (::xml_schema::string_pskel&);

    void
    Toolchain_parser (::xml_schema::string_pskel&);

    void
    SDK_parser (::xml_schema::string_pskel&);
    ...
    //
    protected:
    Installation_pskel* Installation_impl_;
    Installation_pskel (Installation_pskel*, void*);
    ...
    ::xml_schema::string_pskel* Python_parser_;
    ::xml_schema::string_pskel* Toolchain_parser_;
    ::xml_schema::string_pskel* SDK_parser_;

    public:
    struct v_state_descr_
    {
      void (::installationxml::Installation_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xsde::cxx::ro_string&,
        const ::xsde::cxx::ro_string&,
...
#endif // W__WORKSPACE_EG_SRC_SCHEMA_INSTALLATION_SCHEMA_PSKEL_HXX
