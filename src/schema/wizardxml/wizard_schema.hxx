...
namespace wizardxml
{
  ...
  class Wizard
  {
    ...
    // Project
    //
    typedef ::xsde::cxx::string_sequence Project_sequence;
    typedef Project_sequence::iterator Project_iterator;
    typedef Project_sequence::const_iterator Project_const_iterator;
