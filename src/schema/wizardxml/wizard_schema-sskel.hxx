...
#ifndef W__WORKSPACE_EG_SRC_SCHEMA_WIZARD_SCHEMA_SSKEL_HXX
#define W__WORKSPACE_EG_SRC_SCHEMA_WIZARD_SCHEMA_SSKEL_HXX
...
namespace wizardxml
{
  class Wizard_sskel: public ::xsde::cxx::serializer::validating::complex_content
  {
    public:
    ...
    //
    void
    Project_serializer (::xml_schema::string_sskel&);
    ...
    protected:
    Wizard_sskel* Wizard_impl_;
    Wizard_sskel (Wizard_sskel*, void*);

    protected:
    ::xml_schema::string_sskel* Project_serializer_;
  };
}
...
#endif // W__WORKSPACE_EG_SRC_SCHEMA_WIZARD_SCHEMA_SSKEL_HXX
