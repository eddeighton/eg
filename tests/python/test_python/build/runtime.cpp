...
eg::TimeStamp getTimestamp( eg::TypeID typeID, eg::Instance instance )
{
    switch( typeID )
    {
        case 16: return g_root[ instance ].g_root_reference.data.timestamp;
        case 23: return g_root_Test[ instance ].g_root_Test_reference.data.timestamp;
...
eg::ActionState getState( eg::TypeID typeID, eg::Instance instance )
{
    switch( typeID )
    {
        case 16: return g_root[ instance ].g_root_state;
        case 23: return g_root_Test[ instance ].g_root_Test_state;
        default: throw std::runtime_error( "Invalid action instance" );
    }
}
boost::fibers::fiber& getFiber( eg::TypeID typeID, eg::Instance instance )
{
    switch( typeID )
    {
        case 16: return g_root[ instance ].g_root_fiber;
        case 23: return g_root_Test[ instance ].g_root_Test_fiber;
        default: throw std::runtime_error( "Invalid action instance" );
    }
}
eg::TimeStamp getStopCycle( eg::TypeID typeID, eg::Instance instance )
{
    switch( typeID )
    {
        case 16: return g_root[ instance ].g_root_cycle;
        case 23: return g_root_Test[ instance ].g_root_Test_cycle;
        default: throw std::runtime_error( "Invalid action instance" );
    }
}
__eg_root< void > get_root()
{
    return  __eg_root< void >( eg::reference{ 0, 16, getTimestamp( 16, 0 ) } );
}
