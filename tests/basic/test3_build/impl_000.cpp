...
template<>
__interface_root< void >::__interface_x< void >::Read
...
<
    ...
    __eg_type_path< x >,
    Write,
__interface_root< void >::__interface_x< void >::Write
>
( __interface_root< void > context,__interface_root< void >::__interface_x< void >::Write value )
{
    EGInstance var_1 = context.data.instance;
    g_root[ var_1 ].m_x = value;
}
