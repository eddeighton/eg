...
__eg_root< void >::__eg_Line< void >::__eg_Idle< void > root_Line_Idle_starter( eg::Instance _gid );
...
<
    __eg_root< void >::__eg_Line< void >::__eg_Distance< void >::Read,
    __eg_root< void >::__eg_Line< void >::__eg_Idle< void >,
    __eg_type_path< Distance >,
    __eg_ImpNoParams
>
{
    __eg_root< void >::__eg_Line< void >::__eg_Distance< void >::Read operator()( __eg_root< void >::__eg_Line< void >::__eg_Idle< void > context )
    {
        return g_root_Line[ context.data.instance ].m_Distance;
    }
};
...
>
{
    __eg_root< void >::__eg_Line< void >::__eg_Speed< void >::Read operator()( __eg_root< void >::__eg_Line< void >::__eg_Idle< void > context )
    {
        return g_root_Line[ context.data.instance ].m_Speed;
    }
};
...
<
    __eg_root< void >::__eg_Line< void >::__eg_Idle< void >,
    __eg_root< void >::__eg_Line< void >::__eg_Sequencer< void >,
    __eg_type_path< __eg_root< void >::__eg_Line< void >::__eg_Idle< void > >,
    __eg_ImpNoParams
>
{
    template< typename... Args >
    __eg_root< void >::__eg_Line< void >::__eg_Idle< void > operator()( __eg_root< void >::__eg_Line< void >::__eg_Sequencer< void > context, Args... args )
    {
        __eg_root< void >::__eg_Line< void >::__eg_Idle< void > ref = root_Line_Idle_starter( context.data.instance );
        if( ref )
        {
            ref( args... );
            root_Line_Idle_stopper( ref.data.instance );
        }
        return ref;
    }
};
...
//root::Line::Idle
template<>
struct eg::is_convertible< __eg_root< void >::__eg_Line< void >::__eg_Idle< void >, __eg_root< void >::__eg_Line< void >::__eg_Idle< void > >
{
    static constexpr const bool value = true;
};
template< typename __eg1 >
...
template< typename __eg3 >
template< typename TFrom >
__eg_root< __eg1 >::__eg_Line< __eg2 >::__eg_Idle< __eg3 >::__eg_Idle( const TFrom& from )
{
  static_assert( eg::is_convertible< TFrom, __eg_root< void >::__eg_Line< void >::__eg_Idle< void > >::value, "Incompatible eg type conversion" );
  switch( from.data.type )
  {
     case 117: //root::Line::Idle
         data = from.data;
         break;
     default:
         data.timestamp = eg::INVALID_TIMESTAMP;
...
template< typename __eg3 >
template< typename TFrom >
typename __eg_root< __eg1 >::template __eg_Line< __eg2 >::template __eg_Idle< __eg3 >& __eg_root< __eg1 >::__eg_Line< __eg2 >::__eg_Idle< __eg3 >::operator=( const TFrom& from )
{
  static_assert( eg::is_convertible< TFrom, __eg_root< void >::__eg_Line< void >::__eg_Idle< void > >::value, "Incompatible eg type conversion" );
  switch( from.data.type )
  {
...
template<>
inline eg::TimeStamp getTimestamp< __eg_root< void >::__eg_Line< void >::__eg_Idle< void > >( eg::TypeID type, eg::Instance instance )
{
    return g_root_Line_Idle[ instance ].g_root_Line_Idle_reference.data.timestamp;
}

template<>
inline eg::TimeStamp getStopCycle< __eg_root< void >::__eg_Line< void >::__eg_Idle< void > >( eg::TypeID type, eg::Instance instance )
{
    return g_root_Line_Idle[ instance ].g_root_Line_Idle_cycle;
}

template<>
inline eg::ActionState getState< __eg_root< void >::__eg_Line< void >::__eg_Idle< void > >( eg::TypeID type, eg::Instance instance )
{
    return g_root_Line_Idle[ instance ].g_root_Line_Idle_state;
}
...
template< typename __eg3 >
template< typename TypePath, typename Operation, typename... Args >
typename eg::result_type< typename __eg_root< __eg1 >::template __eg_Line< __eg2 >::template __eg_Idle< __eg3 >, TypePath, Operation >::Type
__eg_root< __eg1 >::__eg_Line< __eg2 >::__eg_Idle< __eg3 >::invoke( Args... args ) const
{
    using CanonicalTypePathType = typename eg::CanonicaliseTypePath< TypePath >::Type;
    return __invoke_impl< typename eg::result_type< __eg_root< __eg1 >::__eg_Line< __eg2 >::__eg_Idle< __eg3 >, TypePath, Operation >::Type, __eg_root< __eg1 >::__eg_Line< __eg2 >::__eg_Idle< __eg3 >, CanonicalTypePathType, Operation >()( *this, args... );
}
