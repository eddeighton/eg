...
function( link_boost targetname lib )
    ...
    target_link_libraries( ${targetname} PUBLIC Boost::${lib} )
endfunction( link_boost )

function( link_boost_usual targetname )
	compiler_define_boost( ${targetname} )
    target_link_libraries( ${targetname} PUBLIC Boost::program_options )
    target_link_libraries( ${targetname} PUBLIC Boost::filesystem )
    target_link_libraries( ${targetname} PUBLIC Boost::system )
